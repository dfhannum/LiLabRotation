...
wbm$figure.labels <- ifelse(wbm$figure.labels != 'MK', wbm$figure.labels,
                            ifelse(wbm$UMAP1 < 0, 'MK-1','MK-2'))

wbm$figure.labels <- ifelse(wbm$figure.labels != 'Mono/Macro', 
...
wbm$figure.labels <- factor(wbm$figure.labels,
                            levels = levels(as.factor(wbm$figure.labels))[c(5,3,1,2,12,10,11,4,8,9,6,7)])
